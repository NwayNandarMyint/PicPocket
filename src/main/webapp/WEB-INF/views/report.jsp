...
<body>
  ...
  <div class="container">
            <form:form action="addreport" method="post" modelAttribute="report" enctype="multipart/form-data">
             
             <form:label path="photo_title" >Title</form:label>
            <form:input type="text" path="photo_title" class="input-field"  readonly="true" disabled="true" ></form:input>
            
          	<form:label path="description" >Description</form:label>
            <form:textarea type="text" path="description" class="input-field" required="required" ></form:textarea>
            
            
            <form:label path="photo_id" class="form-label">Photo ID</form:label> 
            <form:input type="text" path="photo_id" class="input-field" required="required" ></form:input>
