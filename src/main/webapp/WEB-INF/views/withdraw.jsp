...
<div class="wrapper">
  ...
  <form:form action="withdraw" methpod="post" modelAttribute="walletEx">
    <div class="amount">
      <p>Enter Coin</p>
      <form:input type="text" path="amount" required="required"/>
    </div>
     <form:hidden path="wallet_id"/>
    <div>
    <p>Password</p>
    <form:input type="text" path="password" required="requied"/>
    </div>
    <div class="drop-list">
      <div class="from">
        <p>User Name</p>
    ...
    <div class="exchange-rate">Currency exchange....</div>
