...
<body>
	...
	<div class="container">
        ...
        <div class="header"> 
           <a href="/picpocket/admins/adminviewbuyphoto?id=${userid }"><i class="fa-solid fa-backward fa-2xl"></i></a>
            <h1>Sell Photo</h1>
       </div>
				...
				<c:otherwise>
					<c:forEach items="${sellposts}" var="sellpost">
						...
						<figure>
							...
							<a href="/picpocket/admins/adminviewbuyphoto?id=${sellpost.id}"><img src="data:image/jpeg;base64,${sellpost.base64image}" height="100%" width="100%" alt="Blob Image"/></a>
							<figcaption>
