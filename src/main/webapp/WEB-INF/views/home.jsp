...
<body>
        ...
        <div class="page-header">
            ...
            <ul>
               <li><a href="/picpocket/users/add" class="create">Create</a></li>
                <li><a href="/picpocket/users/home"  class="active" style="--navAni:1">Home</a></li>
            ...
            <div class="dropdown-content">
                ...
                <li> <a href="#"><i class="fas fa-bell" id="confirmButton"></i></a></li>
				...
				<c:otherwise>
					<c:forEach items="${photos}" var="phh">
						...
						<figure>
							...
							<a href="/picpocket/users/buyphoto?id=${phh.id}"><img src="data:image/jpeg;base64,${phh.base64image}" height="100%" width="100%" alt="Blob Image"/></a>
							<figcaption>
	...
	<div class="footer">
        <p>&copy; 2024 PickPockets | <a href="#" class="footer1">Privacy Policy</a> | <a href="termofservice" class="footer1">Terms of Service</a></p>
    </div>
      ...
      <div class="notifi-item">
        <div class="text">
          <c:forEach var="notification" items="${notiList}">
            ...
            <%-- <c:forEach var="notification" items="${notiList}">
              <a href="readedNoti/${notification.id }">
              <h4>${notification.title}</h4>
              <p>${notification.dateTime }</p>
              </a>
            </c:forEach> --%>
